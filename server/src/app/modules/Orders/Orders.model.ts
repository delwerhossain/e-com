...
const orderSchema = new Schema(
  {
    ...
    paymentMethod: {
      ...
      enum: {
        ...
        message:
          'Payment method must be one of the following: credit card, paypal, bank transfer, or cash on delivery',
      },
    ...
    orderStatus: {
      ...
      enum: {
        ...
        message:
          'Order status must be either processing, shipped, delivered, or cancelled',
      },
      default: 'processing',
    },
    transactionId: {
